use sahyadri_consensus_core::constants::TX_VERSION;
...
impl Config {
    ...
    /// The arguments should be obtained from the current consensus [`sahyadri_consensus_core::config::params::Params`] instance.
    ...
    pub(crate) fn minimum_feerate(&self) -> f64 {
        // The parameter minimum_relay_transaction_fee is in kana/kg units so divide by 1000 to get kana/gram
