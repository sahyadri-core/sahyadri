...
const PREALLOC_AMOUNT_KANA: u64 = 1;
const SUBMIT_TX_CLIENTS: usize = 2;

/// `cargo test --release --package sahyadri-testing-integration --lib --features devnet-prealloc -- rpc_perf_benchmarks::bench_rpc_high_load --exact --nocapture --ignored`
#[tokio::test]
#[ignore = "bmk"]
...
async fn bench_rpc_high_load() {
    ...
    let dag_info = main_client.get_sahyadri_dag_info().await.unwrap();
