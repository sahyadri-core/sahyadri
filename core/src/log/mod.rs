...
cfg_if::cfg_if! {
    if #[cfg(not(target_arch = "wasm32"))] {
        ...
        pub use appender::RAIGAD_KEYWORD;
    }
}
...
macro_rules! trace {
    ($($t:tt)*) => {
        if sahyadri_core::log::workflow_log::log_level_enabled(log::Level::Trace) {
            sahyadri_core::log::workflow_log::impls::trace_impl(None, &format_args!($($t)*));
        }
    };
}
...
macro_rules! debug {
    ($($t:tt)*) => (
        if sahyadri_core::log::workflow_log::log_level_enabled(log::Level::Debug) {
            sahyadri_core::log::workflow_log::impls::debug_impl(None, &format_args!($($t)*));
        }
    )
}
...
macro_rules! info {
    ($($t:tt)*) => (
        if sahyadri_core::log::workflow_log::log_level_enabled(log::Level::Info) {
            sahyadri_core::log::workflow_log::impls::info_impl(None, &format_args!($($t)*));
        }
    )
}
...
macro_rules! warn {
    ($($t:tt)*) => (
        if sahyadri_core::log::workflow_log::log_level_enabled(log::Level::Warn) {
            sahyadri_core::log::workflow_log::impls::warn_impl(None, &format_args!($($t)*));
        }
    )
}
...
macro_rules! error {
    ($($t:tt)*) => (
        if sahyadri_core::log::workflow_log::log_level_enabled(log::Level::Error) {
            sahyadri_core::log::workflow_log::impls::error_impl(None, &format_args!($($t)*));
        }
    )
}
