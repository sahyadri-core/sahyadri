use sahyadri_consensus_core::subnets::SubnetworkConversionError;
use thiserror::Error;
...
pub enum ConversionError {
    ...
    #[error("Bytes size mismatch error {0}")]
    UintBytesSizeError(#[from] sahyadri_math::uint::TryFromSliceError),
    ...
    #[error(transparent)]
    CompressedParentsError(#[from] sahyadri_consensus_core::errors::header::CompressedParentsError),
}
