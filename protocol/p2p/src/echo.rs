...
use sahyadri_core::{debug, time::unix_now, trace, warn};
use std::sync::Arc;
...
impl EchoFlow {
    pub async fn register(router: Arc<Router>) {
        ...
        let receiver = router.subscribe(vec![
            SahyadridMessagePayloadType::Addresses,
            SahyadridMessagePayloadType::Block,
            SahyadridMessagePayloadType::Transaction,
            SahyadridMessagePayloadType::BlockLocator,
            SahyadridMessagePayloadType::RequestAddresses,
            SahyadridMessagePayloadType::RequestRelayBlocks,
            SahyadridMessagePayloadType::RequestTransactions,
            SahyadridMessagePayloadType::IbdBlock,
            SahyadridMessagePayloadType::InvRelayBlock,
            SahyadridMessagePayloadType::InvTransactions,
            SahyadridMessagePayloadType::Ping,
            SahyadridMessagePayloadType::Pong,
            // SahyadridMessagePayloadType::Verack,
            // SahyadridMessagePayloadType::Version,
            // SahyadridMessagePayloadType::Ready,
            SahyadridMessagePayloadType::TransactionNotFound,
            SahyadridMessagePayloadType::Reject,
            SahyadridMessagePayloadType::PruningPointUtxoSetChunk,
            SahyadridMessagePayloadType::RequestIbdBlocks,
            SahyadridMessagePayloadType::UnexpectedPruningPoint,
            SahyadridMessagePayloadType::IbdBlockLocator,
            SahyadridMessagePayloadType::IbdBlockLocatorHighestHash,
            ...
            SahyadridMessagePayloadType::BlockWithTrustedData,
            SahyadridMessagePayloadType::DoneBlocksWithTrustedData,
            SahyadridMessagePayloadType::RequestPruningPointAndItsAnticone,
            SahyadridMessagePayloadType::BlockHeaders,
            SahyadridMessagePayloadType::RequestNextHeaders,
            SahyadridMessagePayloadType::DoneHeaders,
            SahyadridMessagePayloadType::RequestPruningPointUtxoSet,
            SahyadridMessagePayloadType::RequestHeaders,
            SahyadridMessagePayloadType::RequestBlockLocator,
            SahyadridMessagePayloadType::PruningPoints,
            SahyadridMessagePayloadType::RequestPruningPointProof,
            SahyadridMessagePayloadType::PruningPointProof,
            SahyadridMessagePayloadType::BlockWithTrustedDataV4,
            SahyadridMessagePayloadType::TrustedData,
            SahyadridMessagePayloadType::RequestIbdChainBlockLocator,
            SahyadridMessagePayloadType::IbdChainBlockLocator,
            SahyadridMessagePayloadType::RequestAntipast,
    ...
    async fn call(&self, msg: pb::SahyadridMessage) -> bool {
        // echo
...
fn build_dummy_version_message() -> VersionMessage {
    pb::VersionMessage {
        ...
        subnetwork_id: None,
        network: "sahyadri-mainnet".to_string(),
    }
}
...
impl ConnectionInitializer for EchoFlowInitializer {
    async fn initialize_connection(&self, router: Arc<Router>) -> Result<(), ProtocolError> {
        //
        // Example code to illustrate sahyadri P2P handshaking
        //

        // Build the handshake object and subscribe to handshake messages
        let mut handshake = SahyadridHandshake::new(&router);
...
mod tests {
    ...
    use sahyadri_utils::networking::NetAddress;

    #[tokio::test]
    async fn test_handshake() {
        sahyadri_core::log::try_init_logger("debug");
