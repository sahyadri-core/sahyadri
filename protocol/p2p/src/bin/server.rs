...
use sahyadri_p2p_lib::echo::EchoFlowInitializer;
...
async fn main() {
    // [-] - init logger
    sahyadri_core::log::init_logger(None, "debug");
    ...
    let adaptor = sahyadri_p2p_lib::Adaptor::bidirectional(ip_port, sahyadri_p2p_lib::Hub::new(), initializer, Default::default()).unwrap();
    // [1] - connect to a few peers
    let ip_port = String::from("[::1]:26111");
    for i in 0..1 {
