...
pub mod test_helpers {
    ...
    /// Creates the value of the spent output minus provided `fee` (in kana).
    ...
    /// and `fee` (in kana) and second one of `change` amount.
    ///
    /// If no change is provided, creates only one output with the value of the spent outputs minus and `fee` (in kana)
    ...
    fn test_extract_address_and_encode_script() {
        ...
        let tests = vec![
            Test {
                ...
                expected_address: Ok("sahyadri:qpauqsvk7yf9unexwmxsnmg547mhyga37csh0kj53q6xxgl24ydxjsgzthw5j".try_into().unwrap()),
            },
            Test {
                ...
                expected_address: Ok("sahyadritest:qxaqrlzlf6wes72en3568khahq66wf27tuhfxn5nytkd8tcep2c0vrse6gdmpks".try_into().unwrap()),
            },
            Test {
