...
opcode_list! {
    ...
    opcode OpIf<0x63, 1>(self, vm) {
        ...
        if vm.is_executing() {
            ...
            // the similar flow of go-sahyadrid
    ...
    opcode OpCheckLockTimeVerify<0xb0, 1>(self, vm) {
        match vm.script_source {
            ScriptSource::TxInput {input, tx, ..} => {
                ...
                // condition would result in the transaction being allowed into the SahyadriDAG
...
mod test {
    ...
    use sahyadri_consensus_core::constants::{KANA_PER_SAHYADRI, TX_VERSION};
    ...
    mod kip10 {
        ...
        use sahyadri_consensus_core::tx::MutableTransaction;
