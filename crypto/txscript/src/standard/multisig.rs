...
// // TODO: Rewrite multisig tests for Dilithium
// // #[cfg(test)]
// // mod tests {
//     use super::*;
...
//         hashing::{
//             sighash::{SigHashReusedValuesUnsync, calc_ecdsa_signature_hash, calc_Dilithium3_signature_hash},
...
//         };
//         let msg = Dilithium::Message::from_digest_slice(sig_hash.as_bytes().as_slice()).unwrap();
//         let signatures: Vec<_> = inputs
//             .iter()
//             .filter(|input| input.sign)
//             .flat_map(|input| {
//                 if !is_ecdsa {
//                     let sig = *input.kp.sign_Dilithium3(msg).as_ref();
