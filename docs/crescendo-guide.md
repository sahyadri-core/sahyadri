# Sahyadri Crescendo Hardfork Node Setup Guide
...
1. **Obtain Sahyadri v1.0.0 binaries**  
    Download and extract the official [1.0.0 release](https://github.com/sahyadrinet/rusty-sahyadri/releases/tag/v1.0.0), or build from the `master` branch by following the instructions in the project README.
...
Make sure that you get the updated `message.proto` and `rpc.proto` from the rusty-sahyadri repo at https://github.com/sahyadrinet/rusty-sahyadri/tree/master/rpc/grpc/core/proto
