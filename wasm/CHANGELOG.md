Latest online documentation available at: https://sahyadri.aspectron.org/docs/
...
- Rename `sahyadri-beacon` app to `sahyadri-resolver`
...
- Introduced `Beacon` class that provides connectivity to the community-operated public node infrastructure (backed by `sahyadri-beacon` load balancer & node status monitor)
...
- Changed documentation structure to use `typedoc` available as a part of redistributables or online at https://sahyadri.aspectron.org/docs/
