...
(async () => {
    ...
    if (!entries.length) {
        ...
        //
        // priorityFee: a priodityFee value in Kana
        ...
        let generator = new Generator({
            entries,
            outputs: [{address, amount : sahyadriToKana(0.2)}],
            // priorityFee: 1000n,
            priorityFee: sahyadriToKana(0.0001),
            changeAddress: sourceAddress,
        });

        // transaction generator creates a 
        // sequence of transactions
        // for a requested amount of CSM.
