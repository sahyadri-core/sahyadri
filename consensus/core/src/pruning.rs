...
pub struct PruningPointTrustedData {
    ...
    /// Union of SAHYADRI_CONSENSUS data required to verify blocks in the future of the pruning point
    pub sahyadri_consensus_blocks: Vec<TrustedSahyadriConsensusData>,
}
