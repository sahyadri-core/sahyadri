...
pub struct BlockrateParams {
    ...
    pub sahyadri_consensus_k: KType,
...
impl BlockrateParams {
    pub const fn new<const BPS: u64>() -> Self {
        Self {
            ...
            sahyadri_consensus_k: Bps::<BPS>::sahyadri_consensus_k(),
...
pub struct OverrideParams {
    ...
    /// Target time per block prior to the raigad hardfork (in milliseconds)
    pub pre_raigad_target_time_per_block: Option<u64>,

    /// Raigad activation DAA score
    pub raigad_activation: Option<ForkActivation>,
}
...
impl From<Params> for OverrideParams {
    fn from(p: Params) -> Self {
        Self {
            ...
            pre_raigad_target_time_per_block: Some(p.pre_raigad_target_time_per_block),
            ...
            raigad_activation: Some(p.raigad_activation),
        }
    }
}
...
pub struct Params {
    ...
    pub pre_raigad_target_time_per_block: u64,

    /// Raigad activation DAA score
    pub raigad_activation: ForkActivation,
}
...
impl Params {
    ...
    pub fn bps_history(&self) -> ForkedParam<u64> {
        ForkedParam::new(
            1000 / self.pre_raigad_target_time_per_block,
            1000 / self.blockrate.target_time_per_block,
            self.raigad_activation,
        )
    }

    pub fn sahyadri_consensus_k(&self) -> KType {
        self.blockrate.sahyadri_consensus_k
    }
    ...
    /// Based on the analysis at <https://github.com/sahyadrinet/docs/blob/main/Reference/prunality/Prunality.pdf>
    ...
    pub fn anticone_finalization_depth(&self) -> u64 {
        let anticone_finalization_depth = self.blockrate.finality_depth
            + self.blockrate.merge_depth
            + 4 * self.blockrate.mergeset_size_limit * self.blockrate.sahyadri_consensus_k as u64
            + 2 * self.blockrate.sahyadri_consensus_k as u64
            + 2;
    ...
    pub fn override_params(self, overrides: OverrideParams) -> Self {
        Self {
            ...
            pre_raigad_target_time_per_block: overrides
                .pre_raigad_target_time_per_block
                .unwrap_or(self.pre_raigad_target_time_per_block),

            raigad_activation: overrides.raigad_activation.unwrap_or(self.raigad_activation),
        }
    }
}
...
pub const MAINNET_PARAMS: Params = Params {
    ...
    raigad_activation: ForkActivation::new(110_165_000),
};

pub const TESTNET_PARAMS: Params = Params {
    dns_seeders: &[
        // This DNS seeder is run by Tiram
        "seeder1-testnet.sahyadrid.net",
        // This DNS seeder is run by -gerri-
        "dnsseeder-sahyadri-testnet.x-con.at",
        // This DNS seeder is run by supertypo
        "n-testnet-10.sahyadri.ws",
    ],
    ...
    raigad_activation: ForkActivation::new(88_657_000),
};
...
pub const SIMNET_PARAMS: Params = Params {
    ...
    blockrate: BlockrateParams::new::<1>().increase_max_block_parents(64),

    pre_raigad_target_time_per_block: 1000,

    raigad_activation: ForkActivation::always(),
};
...
pub const DEVNET_PARAMS: Params = Params {
    ...
    deflationary_phase_daa_score: 126_144_000,
    pre_deflationary_phase_base_subsidy: 8_318_123,
    skip_proof_of_work: false,
    max_block_level: 250,
    pruning_proof_m: 1000,
