...
pub const GENESIS: GenesisBlock = GenesisBlock {
    hash: Hash::from_bytes([
        0xb8, 0xcb, 0x5b, 0xf2, 0x1e, 0x44, 0x81, 0x94,
        0xf9, 0x64, 0x35, 0x71, 0x27, 0x27, 0xb2, 0x5f,
        0xd8, 0x2a, 0x14, 0x4e, 0xdd, 0x75, 0xa7, 0x32,
        0x1e, 0xda, 0x36, 0x85, 0x25, 0x15, 0xcc, 0xef,
    ]),
    version: 0,
...
pub const TESTNET_GENESIS: GenesisBlock = GenesisBlock {
    hash: Hash::from_bytes([
            0x15, 0x3f, 0x85, 0x89, 0xe6, 0x99, 0xac, 0x2e,
            0xf6, 0xe6, 0xfc, 0x03, 0xb9, 0x36, 0x86, 0x80,
            0x4c, 0x0e, 0x79, 0x38, 0xd8, 0xbb, 0x21, 0xf2,
            0xc1, 0x7b, 0xc8, 0x75, 0x81, 0x6b, 0xce, 0xd1,
    ]),
    version: 0,
    hash_merkle_root: Hash::from_bytes([
