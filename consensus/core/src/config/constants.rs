pub mod consensus {
    ...
    pub const SAHYADRI_CONSENSUS_TAIL_DELTA: f64 = 0.01;
    ...
    /// Highest proof of work difficulty target a Sahyadri block can have for all networks.
