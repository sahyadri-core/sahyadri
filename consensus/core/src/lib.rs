...
//! # Consensus Core
//!
//! This crate implements primitives used in the Sahyadri node consensus processing.
//!
...
pub type BlueWorkType = sahyadri_math::Uint192;
...
/// The type used to represent the SAHYADRI_CONSENSUS K parameter
pub type KType = u16;
