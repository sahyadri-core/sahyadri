...
pub enum Error {
    ...
    #[error(transparent)]
    ScriptBuilder(#[from] sahyadri_txscript::script_builder::ScriptBuilderError),
    ...
    #[error(transparent)]
    CompressedParents(#[from] sahyadri_consensus_core::errors::header::CompressedParentsError),
