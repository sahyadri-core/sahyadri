//!
//! # Standardized JSON serialization and deserialization of Sahyadri transactions.
//!
//! This module provides standardized JSON serialization and deserialization of
//! Sahyadri transactions. There are two sub-modules: `numeric` and `string`.
//!
...
//! For more advanced use cases, please refer to `PSKT` in the [`sahyadri_wallet_pskt`](https://docs.rs/sahyadri_wallet_pskt)
//! crate.
//!
