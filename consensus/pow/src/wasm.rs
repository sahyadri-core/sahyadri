...
/// Represents a Sahyadri header PoW manager
/// @category Mining
...
impl PoW {
    ...
    pub fn new(header: &HeaderT, timestamp: Option<u64>) -> Result<PoW> {
        ...
        Ok(Self { inner: crate::State { matrix, target, hasher, memory_loop: crate::memory_loop::MemoryLoop::new(&pre_pow_hash) }, pre_pow_hash })
    }
    ...
    pub fn from_raw(pre_pow_hash: &str, timestamp: u64, target_bits: Option<u32>) -> Result<PoW> {
        ...
        Ok(PoW { inner: crate::State { matrix, target, hasher, memory_loop: crate::memory_loop::MemoryLoop::new(&pre_pow_hash) }, pre_pow_hash })
    }
}

// https://github.com/tmrlvi/sahyadri-miner/blob/bf361d02a46c580f55f46b5dfa773477634a5753/src/client/stratum.rs#L36
...
/// <https://github.com/tmrlvi/sahyadri-miner/blob/bf361d02a46c580f55f46b5dfa773477634a5753/src/client/stratum.rs#L375>
/// @category Mining
