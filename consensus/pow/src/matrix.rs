...
use sahyadri_hashes::{Hash, SahyadriX};
...
impl Matrix {
    ...
    pub fn heavy_hash(&self, hash: Hash) -> Hash {
        ...
        SahyadriX::hash(&Hash::from_bytes(product).as_bytes())
    }
}
...
mod tests {
    ...
    fn test_heavy_hash() {
        let expected_hash = Hash::from_bytes([
            64, 49, 182, 246, 176, 49, 206, 114, 255, 63, 92, 13, 90, 175, 101, 130, 
            160, 226, 166, 3, 27, 13, 106, 178, 143, 158, 78, 139, 223, 219, 252, 232,
        ]);
        #[rustfmt::skip]
