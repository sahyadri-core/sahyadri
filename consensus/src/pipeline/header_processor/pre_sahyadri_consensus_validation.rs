...
use sahyadri_consensus_core::blockhash::BlockHashExtensions;
use sahyadri_consensus_core::blockstatus::BlockStatus::StatusInvalid;
...
impl HeaderProcessor {
    ...
    fn check_pow_and_calc_block_level(&self, header: &Header) -> BlockProcessResult<BlockLevel> {
        let state = sahyadri_pow::State::new(header);
