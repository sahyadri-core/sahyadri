...
mod tests {
    ...
    use crate::{
        ...
        errors::RuleError,
        model::stores::sahyadri_consensus::SahyadriConsensusStoreReader,
    ...
    async fn validate_body_in_context_test() {
...

        {
            ...
            let valid_block_child_gd = consensus.sahyadri_consensus_store().get_data(valid_block_child.header.hash).unwrap();
