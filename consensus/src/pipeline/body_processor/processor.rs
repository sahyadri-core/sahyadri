...
pub struct BlockBodyProcessor {
    ...
    pub(super) _sahyadri_consensus_k: KType,

    // Stores
    pub(super) statuses_store: Arc<RwLock<DbStatusesStore>>,
    pub(super) _sahyadri_consensus_store: Arc<DbSahyadriConsensusStore>,
...
impl BlockBodyProcessor {
    pub fn new(
        ...
        Self {
            ...
            _sahyadri_consensus_k: params.sahyadri_consensus_k(),

            statuses_store: storage.statuses_store.clone(),
            _sahyadri_consensus_store: storage.sahyadri_consensus_store.clone(),
