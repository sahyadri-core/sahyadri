...
>;
pub type DbBlockDepthManager = BlockDepthManager<DbDepthStore, DbReachabilityStore, DbSahyadriConsensusStore, DbHeadersStore>;
...
pub struct ConsensusServices {
    ...
    pub sahyadri_consensus_manager: DbSahyadriConsensusManager,
...
impl ConsensusServices {
    pub fn new(
        ...
        let dag_traversal_manager = DagTraversalManager::new(
            params.genesis.hash,
            storage.sahyadri_consensus_store.clone(),
        ...
        let sahyadri_consensus_manager = SahyadriConsensusManager::new(
            params.genesis.hash,
        ...
        let pruning_proof_manager = Arc::new(PruningProofManager::new(
            ...
            reachability_service.clone(),
            sahyadri_consensus_manager.clone(),
