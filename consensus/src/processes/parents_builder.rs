...
mod tests {
    ...
    impl HeaderStoreReader for HeaderStoreMock {
        fn get_daa_score(&self, hash: sahyadri_hashes::Hash) -> Result<u64, StoreError> {
            unimplemented!()
        }

        fn get_timestamp(&self, hash: sahyadri_hashes::Hash) -> Result<u64, StoreError> {
            unimplemented!()
        }

        fn get_bits(&self, hash: sahyadri_hashes::Hash) -> Result<u32, StoreError> {
            unimplemented!()
        }

        fn get_header(&self, hash: sahyadri_hashes::Hash) -> Result<Arc<Header>, StoreError> {
            Ok(self.map.read().get(&hash).unwrap().header.clone())
        }

        fn get_compact_header_data(
            &self,
            hash: sahyadri_hashes::Hash,
        ) -> Result<crate::model::stores::headers::CompactHeaderData, StoreError> {
            unimplemented!()
        }

        fn get_blue_score(&self, hash: sahyadri_hashes::Hash) -> Result<u64, StoreError> {
            unimplemented!()
        }
    ...
    impl RelationsStoreReader for RelationsStoreMock {
        fn get_parents(&self, hash: Hash) -> Result<sahyadri_consensus_core::blockhash::BlockHashes, StoreError> {
            unimplemented!()
        }
