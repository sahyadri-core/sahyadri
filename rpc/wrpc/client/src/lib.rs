//!
//! # wRPC Client for Sahyadri p2p Node
//!
//! This crate provides a WebSocket RPC client for Sahyadri p2p node. It is based on the
...
//! [examples](https://github.com/sahyadrinet/sahyadri/tree/master/rpc/wrpc/examples) folder.
//!
...
mod imports;
pub mod result;
pub use imports::{Resolver, SahyadriRpcClient, WrpcEncoding};
pub mod node;
pub mod parse;
pub mod prelude;
pub mod resolver;
