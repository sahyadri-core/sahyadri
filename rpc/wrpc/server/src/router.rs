...
use sahyadri_rpc_core::{api::ops::RpcApiOps, prelude::*};
use sahyadri_rpc_macros::build_wrpc_server_interface;
use std::sync::Arc;
...
/// a single initialization location for both the Sahyadrid Server and
/// the GRPC Proxy.
pub struct Router {
