//! [`Resolver`](NativeResolver) bindings for obtaining public Sahyadri wRPC URL endpoints.
...
use crate::imports::*;
use js_sys::Array;
pub use sahyadri_rpc_macros::declare_typescript_wasm_interface as declare;
use sahyadri_wrpc_client::Resolver as NativeResolver;
use sahyadri_wrpc_client::node::NodeDescriptor;
use serde::ser;
...
///
/// Resolver is a client for obtaining public Sahyadri wRPC URL.
///
/// Resolver queries a list of public Sahyadri Resolver URLs using HTTP to fetch
...
#[wasm_bindgen]
impl Resolver {
    /// List of public Sahyadri Resolver URLs.
    #[wasm_bindgen(getter)]
    ...
    /// Fetches a public Sahyadri wRPC endpoint for the given encoding and network identifier.
    ...
    /// Fetches a public Sahyadri wRPC endpoint URL for the given encoding and network identifier.
    ...
    /// Connect to a public Sahyadri wRPC endpoint for the given encoding and network identifier
