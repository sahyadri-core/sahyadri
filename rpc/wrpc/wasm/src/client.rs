//!
//! # WASM bindings for the [Sahyadri p2p Node RPC client](SahyadriRpcClient).
//!
//! This module provides a WASM interface for the Sahyadri p2p Node RPC client
//! - [`RpcClient`].
//!
...
use sahyadri_notify::listener;
use sahyadri_notify::notification::Notification as NotificationT;
use sahyadri_rpc_core::api::ctl;
pub use sahyadri_rpc_core::wasm::message::*;
pub use sahyadri_rpc_macros::{
...
pub(crate) struct Inner {
    ...
    notification_channel: Channel<sahyadri_rpc_core::Notification>,
}
...
///
///
/// Sahyadri RPC client uses ([wRPC](https://github.com/workflow-rs/workflow-rs/tree/master/rpc))
/// interface to connect directly with Sahyadri Node. wRPC supports
/// two types of encodings: `borsh` (binary, default) and `json`.
///
/// There are two ways to connect: Directly to any Sahyadri Node or to a
...
/// ```
///
/// **Connecting to a Sahyadri Node directly**
///
/// ```javascript
/// let rpc = new RpcClient({
...
/// to re-register event listeners, but your have to re-subscribe for Sahyadri node
/// notifications:
///
/// ```typescript
/// rpc.addEventListener("connect", async (event) => {
...
impl RpcClient {
    pub fn new(config: Option<RpcConfig>) -> Result<RpcClient> {
        ...
        let client = Arc::new(
            SahyadriRpcClient::new(encoding, url.as_deref(), resolver.clone().map(Into::into), network_id, None)
...
impl RpcClient {
    ...
    /// Connect to the Sahyadri RPC server. This function starts a background
    ...
    /// Disconnect from the Sahyadri RPC server.
    ...
    /// however, you have to re-subscribe for Sahyadri node notifications. As such, it is recommended
...
impl RpcClient {
    pub fn new_with_rpc_client(client: Arc<SahyadriRpcClient>) -> RpcClient {
    ...
    pub fn client(&self) -> &Arc<SahyadriRpcClient> {
        &self.inner.client
    }
...
impl RpcClient {
    ...
    pub fn parse_url(url: &str, encoding: Encoding, network: NetworkId) -> Result<String> {
        let url_ = SahyadriRpcClient::parse_url(url.to_string(), encoding, network.into())?;
        Ok(url_)
    }
}
...
build_wrpc_wasm_bindgen_interface!(
    [
        ...
        /// Retrieves the current number of blocks in the Sahyadri SahyadriDAG.
        ...
        /// structure of the Sahyadri SahyadriDAG.
        ...
        GetSahyadriDagInfo,
        /// Returns the total current coin supply of Sahyadri network.
        /// Returned information: Total coin supply.
        GetCoinSupply,
        /// Retrieves information about the peers connected to the Sahyadri node.
        /// Returned information: Peer ID, IP address and port, connection
        /// status, protocol version.
        GetConnectedPeerInfo,
        /// Retrieves general information about the Sahyadri node.
        /// Returned information: Version of the Sahyadri node, protocol
        /// version, network identifier.
        /// This call is primarily used by gRPC clients.
        /// For wRPC clients, use {@link RpcClient.getServerInfo}.
        GetInfo,
        /// Provides a list of addresses of known peers in the Sahyadri
        ...
        /// performance and status of the Sahyadri node.
        ...
        /// the highest cumulative difficulty in the Sahyadri SahyadriDAG.
        ...
        GetSinkBlueScore,
        /// Tests the connection and responsiveness of a Sahyadri node.
        /// Returned information: None.
        Ping,
        /// Gracefully shuts down the Sahyadri node.
        /// Returned information: None.
        Shutdown,
        /// Retrieves information about the Sahyadri server.
        /// Returned information: Version of the Sahyadri server, protocol
        /// version, network identifier.
        GetServerInfo,
        /// Obtains basic information about the synchronization status of the Sahyadri node.
    ...
    [
        ...
        /// Adds a peer to the Sahyadri node's list of known peers.
        /// Returned information: None.
        AddPeer,
        /// Bans a peer from connecting to the Sahyadri node for a specified duration.
        /// Returned information: None.
        Ban,
        ...
        /// Retrieves the balance of a specific address in the Sahyadri SahyadriDAG.
        /// Returned information: Balance of the address.
        GetBalanceByAddress,
        /// Retrieves balances for multiple addresses in the Sahyadri SahyadriDAG.
        /// Returned information: Balances of the addresses.
        GetBalancesByAddresses,
        /// Retrieves a specific block from the Sahyadri SahyadriDAG.
        /// Returned information: Block information.
        GetBlock,
        /// Retrieves multiple blocks from the Sahyadri SahyadriDAG.
        ...
        /// Retrieves block headers from the Sahyadri SahyadriDAG.
        /// Returned information: List of block headers.
        GetHeaders,
        /// Retrieves mempool entries from the Sahyadri node's mempool.
        ...
        /// Resolves a finality conflict in the Sahyadri SahyadriDAG.
        /// Returned information: None.
        ResolveFinalityConflict,
        /// Submits a block to the Sahyadri network.
        /// Returned information: None.
        SubmitBlock,
        /// Submits a transaction to the Sahyadri network.
        /// Returned information: Submitted Transaction Id.
        SubmitTransaction,
        /// Submits an RBF transaction to the Sahyadri network.
