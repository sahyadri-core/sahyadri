// Basic example of a Sahyadri wRPC client that connects to a node
...
// Sahyadri RPC primitives
use sahyadri_wrpc_client::prelude::*;
// reuse wRPC Result type for convenience
use sahyadri_wrpc_client::result::Result;
...
impl Listener {
    ...
    async fn start_event_task(&self) -> Result<()> {
        ...
        // in the rusty sahyadri framework)
