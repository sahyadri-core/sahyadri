...
pub enum RpcError {
    ...
    #[error(transparent)]
    NetworkTypeError(#[from] sahyadri_consensus_core::network::NetworkTypeError),

    #[error(transparent)]
    NetworkIdError(#[from] sahyadri_consensus_core::network::NetworkIdError),

    #[error(transparent)]
    NotificationError(#[from] sahyadri_notify::error::Error),

    #[error(transparent)]
    MiningManagerError(#[from] sahyadri_mining_errors::manager::MiningManagerError),

    #[error(transparent)]
    ConsensusError(#[from] sahyadri_consensus_core::errors::consensus::ConsensusError),

    #[error(transparent)]
    ScriptClassError(#[from] sahyadri_txscript::script_class::Error),
