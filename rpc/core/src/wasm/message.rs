...
declare! {
    IGetSahyadriDagInfoRequest,
    r#"
    /**
     * @category Node RPC
     */
    export interface IGetSahyadriDagInfoRequest { }
    "#,
}

try_from! ( args: IGetSahyadriDagInfoRequest, GetSahyadriDagInfoRequest, {
    Ok(from_value(args.into())?)
});

declare! {
    IGetSahyadriDagInfoResponse,
    r#"
    /**
     * @category Node RPC
     */
    export interface IGetSahyadriDagInfoResponse {
        network: string;
        blockCount: bigint;
        headerCount: bigint;
        tipHashes: HexString[];
...
try_from! ( args: GetSahyadriDagInfoResponse, IGetSahyadriDagInfoResponse, {
    Ok(to_value(&args)?.into())
});
...
declare! {
    ...
    export interface IFeeEstimate {
         ...
         *
         * Note: for all buckets, feerate values represent fee/mass of a transaction in `kana/gram` units.
