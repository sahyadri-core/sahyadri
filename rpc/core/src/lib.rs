...
//!
//! This crate acts as a foundation for [`sahyadri_grpc_client`](https://docs.rs/sahyadri_grpc_client) and
//! [`sahyadri_wrpc_client`](https://docs.rs/sahyadri_wrpc_client) crates, which provide gRPC and WebSocket
//! RPC client implementations. This crate is also used by WASM bindings to provide [WASM RpcClient
//! implementation](https://docs.rs/sahyadri-wrpc-client/latest/sahyadri_wrpc_client/wasm/struct.RpcClient.html)
//! (based on wRPC).
//!
