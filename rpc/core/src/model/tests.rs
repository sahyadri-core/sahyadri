...
mod mockery {
    ...
    impl Mock for GetSahyadriDagInfoRequest {
        fn mock() -> Self {
            GetSahyadriDagInfoRequest {}
        }
    }

    test!(GetSahyadriDagInfoRequest);

    impl Mock for GetSahyadriDagInfoResponse {
        fn mock() -> Self {
            GetSahyadriDagInfoResponse {
    ...
    test!(GetSahyadriDagInfoResponse);
    ...
    impl Mock for GetCoinSupplyResponse {
        fn mock() -> Self {
            GetCoinSupplyResponse { max_kana: mock(), circulating_kana: mock() }
        }
    }
