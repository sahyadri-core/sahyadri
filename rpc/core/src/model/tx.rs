...
/// Represents the ID of a Sahyadri transaction
...
/// Represent Sahyadri transaction input verbose data
...
/// Represent Sahyadri transaction output verbose data
#[derive(Clone, Debug, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
...
/// Represent Sahyadri transaction verbose data
#[derive(Clone, Debug, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
