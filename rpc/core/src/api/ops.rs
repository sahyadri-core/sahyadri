...
pub enum RpcApiOps {
    ...
    GetSyncStatus = 115,
    /// Returns the network this Sahyadrid is connected to (Mainnet, Testnet)
    ...
    /// Returns a list of all the addresses (IP, port) this Sahyadrid knows and a list of all addresses that are currently banned by this Sahyadrid
    ...
    /// Returns a list of the peers currently connected to this Sahyadrid, along with some statistics on them
    GetConnectedPeerInfo = 123,
    /// Instructs Sahyadrid to connect to a given IP address.
    AddPeer = 124,
