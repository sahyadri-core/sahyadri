use crate::{
    error::{Error, Result},
    resolver::{SahyadridResponseReceiver, SahyadridResponseSender, Resolver},
};
...
impl Pending {
    fn new(sender: SahyadridResponseSender) -> Self {
...
impl Resolver for IdResolver {
    fn register_request(&self, _: SahyadridPayloadOps, request: &SahyadridRequest) -> SahyadridResponseReceiver {
