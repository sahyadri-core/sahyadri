// Example of simple grpc client to connect with Sahyadri node and collect some node and network basic data

use sahyadri_grpc_client::GrpcClient;
use sahyadri_rpc_core::RpcResult;
...
async fn check_node_status() -> RpcResult<()> {
    let url = "grpc://localhost:26110".to_string();
