...
from!(item: &sahyadri_rpc_core::RpcBalancesByAddressesEntry, protowire::RpcBalancesByAddressesEntry, {
...
try_from!(item: &protowire::RpcBalancesByAddressesEntry, sahyadri_rpc_core::RpcBalancesByAddressesEntry, {
