...
use sahyadri_rpc_core::{FromRpcHex, RpcAddress, RpcError, RpcResult, RpcScriptClass, RpcSubnetworkId, ToRpcHex};
use std::str::FromStr;
...
from!(item: &sahyadri_rpc_core::RpcOptionalTransaction, protowire::RpcOptionalTransaction, {
    Self {
...
from!(item: &sahyadri_rpc_core::RpcOptionalTransactionInput, protowire::RpcOptionalTransactionInput, {
    Self {
...
from!(item: &sahyadri_rpc_core::RpcOptionalTransactionOutput, protowire::RpcOptionalTransactionOutput, {
    Self {
        value: item.value,
...
from!(item: &sahyadri_rpc_core::RpcOptionalTransactionVerboseData, protowire::RpcOptionalTransactionVerboseData, {
    Self {
...
from!(item: &sahyadri_rpc_core::RpcOptionalTransactionOutputVerboseData, protowire::RpcOptionalTransactionOutputVerboseData, {
    Self {
...
try_from!(item: &protowire::RpcOptionalTransaction, sahyadri_rpc_core::RpcOptionalTransaction, {
    Self {
        version: item.version.map(|x| x as u16),
        inputs: item.inputs.iter().map(sahyadri_rpc_core::RpcOptionalTransactionInput::try_from).collect::<RpcResult<_>>()?,
        outputs: item.outputs.iter().map(sahyadri_rpc_core::RpcOptionalTransactionOutput::try_from).collect::<RpcResult<_>>()?,
        lock_time: item.lock_time,
...
try_from!(item: &protowire::RpcOptionalTransactionOutput, sahyadri_rpc_core::RpcOptionalTransactionOutput, {
    Self {
        value: item.value,
        script_public_key: item.script_public_key.as_ref().map(sahyadri_rpc_core::RpcScriptPublicKey::try_from).transpose()?,
...
try_from!(item: &protowire::RpcOptionalTransactionVerboseData, sahyadri_rpc_core::RpcOptionalTransactionVerboseData, {
    Self {
        transaction_id: item.transaction_id.as_ref().map(|x| sahyadri_rpc_core::RpcHash::from_str(x)).transpose()?,
        hash: item.hash.as_ref().map(|x| sahyadri_rpc_core::RpcHash::from_str(x)).transpose()?,
        compute_mass: item.compute_mass,
        block_hash: item.block_hash.as_ref().map(|x| sahyadri_rpc_core::RpcHash::from_str(x)).transpose()?,
        block_time: item.block_time,
    }
});
...
try_from!(item: &protowire::RpcOptionalTransactionOutputVerboseData, sahyadri_rpc_core::RpcOptionalTransactionOutputVerboseData, {
    Self {
