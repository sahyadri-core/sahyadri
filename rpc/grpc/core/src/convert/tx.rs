...
use sahyadri_rpc_core::{FromRpcHex, RpcAddress, RpcError, RpcHash, RpcResult, RpcScriptClass, RpcScriptVec, ToRpcHex};
use std::str::FromStr;
...
from!(item: &sahyadri_rpc_core::RpcTransaction, protowire::RpcTransaction, {
    Self {
...
from!(item: &sahyadri_rpc_core::RpcOptionalTransaction, protowire::RpcTransaction, {
    Self {
...
from!(item: &sahyadri_rpc_core::RpcTransactionInput, protowire::RpcTransactionInput, {
    Self {
...
from!(item: &sahyadri_rpc_core::RpcOptionalTransactionInput, protowire::RpcTransactionInput, {
    Self {
...
from!(item: &sahyadri_rpc_core::RpcTransactionOutput, protowire::RpcTransactionOutput, {
    Self {
        amount: item.value,
...
from!(item: &sahyadri_rpc_core::RpcOptionalTransactionOutput, protowire::RpcTransactionOutput, {
    Self {
...
from!(item: &sahyadri_rpc_core::RpcChainBlockAcceptedTransactions, protowire::RpcChainBlockAcceptedTransactions, {
    Self {
...
from!(item: &sahyadri_rpc_core::RpcScriptPublicKey, protowire::RpcScriptPublicKey, {
    Self { version: item.version().into(), script_public_key: item.script().to_rpc_hex() }
});

from!(item: &sahyadri_rpc_core::RpcOptionalTransactionVerboseData, protowire::RpcTransactionVerboseData, {
    Self {
...
from!(item: &sahyadri_rpc_core::RpcTransactionVerboseData, protowire::RpcTransactionVerboseData, {
    Self {
...
from!(item: &sahyadri_rpc_core::RpcTransactionOutputVerboseData, protowire::RpcTransactionOutputVerboseData, {
    Self {
...
from!(item: &sahyadri_rpc_core::RpcOptionalTransactionOutputVerboseData, protowire::RpcTransactionOutputVerboseData, {
Self {
    script_public_key_type: item.script_public_key_type.as_ref().map(|x| x.to_string()).unwrap_or_default(),
    script_public_key_address: item.script_public_key_address.as_ref().map(|x| x.to_string()).unwrap_or_default(),
    }
...
from!(item: &sahyadri_rpc_core::RpcAcceptedTransactionIds, protowire::RpcAcceptedTransactionIds, {
    Self {
...
try_from!(item: &protowire::RpcTransaction, sahyadri_rpc_core::RpcTransaction, {
    Self {
        version: item.version.try_into()?,
        inputs: item
            .inputs
            .iter()
            .map(sahyadri_rpc_core::RpcTransactionInput::try_from)
            .collect::<RpcResult<Vec<sahyadri_rpc_core::RpcTransactionInput>>>()?,
        outputs: item
            .outputs
            .iter()
            .map(sahyadri_rpc_core::RpcTransactionOutput::try_from)
            .collect::<RpcResult<Vec<sahyadri_rpc_core::RpcTransactionOutput>>>()?,
        lock_time: item.lock_time,
        subnetwork_id: sahyadri_rpc_core::RpcSubnetworkId::from_str(&item.subnetwork_id)?,
        gas: item.gas,
        payload: Vec::from_rpc_hex(&item.payload)?,
        mass: item.mass,
        verbose_data: item.verbose_data.as_ref().map(sahyadri_rpc_core::RpcTransactionVerboseData::try_from).transpose()?,
    }
});

try_from!(item: &protowire::RpcTransaction, sahyadri_rpc_core::RpcOptionalTransaction, {
    Self {
        version: Some(item.version.try_into()?),
        inputs: item
            .inputs
            .iter()
            .map(sahyadri_rpc_core::RpcOptionalTransactionInput::try_from)
            .collect::<RpcResult<Vec<sahyadri_rpc_core::RpcOptionalTransactionInput>>>()?,
        outputs: item
            .outputs
            .iter()
            .map(sahyadri_rpc_core::RpcOptionalTransactionOutput::try_from)
            .collect::<RpcResult<Vec<sahyadri_rpc_core::RpcOptionalTransactionOutput>>>()?,
        lock_time: Some(item.lock_time),
        subnetwork_id: Some(sahyadri_rpc_core::RpcSubnetworkId::from_str(&item
            .subnetwork_id)?),
        gas: Some(item.gas),
        payload: Some(Vec::from_rpc_hex(&item.payload)?),
        mass: Some(item.mass),
        verbose_data: item.verbose_data.as_ref().map(sahyadri_rpc_core::RpcOptionalTransactionVerboseData::try_from).transpose()?,
    }
});

try_from!(item: &protowire::RpcTransactionInput, sahyadri_rpc_core::RpcOptionalTransactionInput, {
    Self {
        ...
        verbose_data: item.verbose_data.as_ref().map(sahyadri_rpc_core::RpcOptionalTransactionInputVerboseData::try_from).transpose()?,
    }
});

try_from!(item: &protowire::RpcTransactionInput, sahyadri_rpc_core::RpcTransactionInput, {
    Self {
        previous_outpoint: item
            .previous_outpoint
            .as_ref()
        ...
        verbose_data: item.verbose_data.as_ref().map(sahyadri_rpc_core::RpcTransactionInputVerboseData::try_from).transpose()?,
    }
});

try_from!(item: &protowire::RpcTransactionOutput, sahyadri_rpc_core::RpcTransactionOutput, {
    Self {
        value: item.amount,
        script_public_key: item
            ...
            .try_into()?,
        verbose_data: item.verbose_data.as_ref().map(sahyadri_rpc_core::RpcTransactionOutputVerboseData::try_from).transpose()?,
    }
});

try_from!(item: &protowire::RpcTransactionOutput, sahyadri_rpc_core::RpcOptionalTransactionOutput, {
    Self {
        value: Some(item.amount),
        script_public_key: item
            .script_public_key
            .as_ref()
            .map(sahyadri_rpc_core::RpcScriptPublicKey::try_from)
            .transpose()?,
        verbose_data: item.verbose_data.as_ref().map(sahyadri_rpc_core::RpcOptionalTransactionOutputVerboseData::try_from).transpose()?,
    }
});
...
try_from!(item: &protowire::RpcScriptPublicKey, sahyadri_rpc_core::RpcScriptPublicKey, {
    Self::new(u16::try_from(item.version)?, RpcScriptVec::from_rpc_hex(item.script_public_key.as_str())?)
});

try_from!(item: &protowire::RpcTransactionVerboseData, sahyadri_rpc_core::RpcTransactionVerboseData, {
    Self {
...
try_from!(item: &protowire::RpcTransactionVerboseData, sahyadri_rpc_core::RpcOptionalTransactionVerboseData, {
    Self {
...
try_from!(&protowire::RpcTransactionInputVerboseData, sahyadri_rpc_core::RpcTransactionInputVerboseData);
...
try_from!(item: &protowire::RpcTransactionOutputVerboseData, sahyadri_rpc_core::RpcOptionalTransactionOutputVerboseData, {
    Self {
...
try_from!(item: &protowire::RpcTransactionOutputVerboseData, sahyadri_rpc_core::RpcTransactionOutputVerboseData, {
    Self {
...
try_from!(item: &protowire::RpcAcceptedTransactionIds, sahyadri_rpc_core::RpcAcceptedTransactionIds, {
    Self {
...
try_from!(item: &protowire::RpcChainBlockAcceptedTransactions, sahyadri_rpc_core::RpcChainBlockAcceptedTransactions, {
    Self {
        chain_block_header: item
            .chain_block_header
            .as_ref()
            .map(sahyadri_rpc_core::RpcOptionalHeader::try_from)
            .transpose()?
            .ok_or_else(|| RpcError::MissingRpcFieldError("RpcChainBlockAcceptedTransactions".to_string(), "chain_block_header".to_string()))?,
        accepted_transactions: item.accepted_transactions.iter().map(sahyadri_rpc_core::RpcOptionalTransaction::try_from).collect::<Result<_, _>>()?,
    }
});
