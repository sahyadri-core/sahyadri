...
use sahyadri_consensus_core::{Hash, network::NetworkId};
use sahyadri_core::debug;
use sahyadri_notify::subscription::Command;
...
from!(item: &sahyadri_rpc_core::SubmitBlockReport, RejectReason, {
    match item {
        sahyadri_rpc_core::SubmitBlockReport::Success => RejectReason::None,
        sahyadri_rpc_core::SubmitBlockReport::Reject(sahyadri_rpc_core::SubmitBlockRejectReason::BlockInvalid) => RejectReason::BlockInvalid,
        sahyadri_rpc_core::SubmitBlockReport::Reject(sahyadri_rpc_core::SubmitBlockRejectReason::IsInIBD) => RejectReason::IsInIbd,
        ...
        sahyadri_rpc_core::SubmitBlockReport::Reject(sahyadri_rpc_core::SubmitBlockRejectReason::RouteIsFull) => RejectReason::None,
    }
});

from!(item: &sahyadri_rpc_core::SubmitBlockRequest, protowire::SubmitBlockRequestMessage, {
...
// message is provided.
from!(item: RpcResult<&sahyadri_rpc_core::SubmitBlockResponse>, protowire::SubmitBlockResponseMessage, {
    let error: Option<protowire::RpcError> = match item.report {
        sahyadri_rpc_core::SubmitBlockReport::Success => None,
        sahyadri_rpc_core::SubmitBlockReport::Reject(reason) => Some(RpcError::SubmitBlockError(reason).into())
    };
    Self { reject_reason: RejectReason::from(&item.report) as i32, error }
});

from!(item: &sahyadri_rpc_core::GetBlockTemplateRequest, protowire::GetBlockTemplateRequestMessage, {
    Self {
...
from!(item: RpcResult<&sahyadri_rpc_core::GetBlockTemplateResponse>, protowire::GetBlockTemplateResponseMessage, {
    Self { block: Some((&item.block).into()), is_synced: item.is_synced, error: None }
});

from!(item: &sahyadri_rpc_core::GetBlockRequest, protowire::GetBlockRequestMessage, {
    Self { hash: item.hash.to_string(), include_transactions: item.include_transactions }
});
from!(item: RpcResult<&sahyadri_rpc_core::GetBlockResponse>, protowire::GetBlockResponseMessage, {
    Self { block: Some((&item.block).into()), error: None }
});

from!(item: &sahyadri_rpc_core::NotifyBlockAddedRequest, protowire::NotifyBlockAddedRequestMessage, {
    Self { command: item.command.into() }
});
from!(RpcResult<&sahyadri_rpc_core::NotifyBlockAddedResponse>, protowire::NotifyBlockAddedResponseMessage);

from!(&sahyadri_rpc_core::GetInfoRequest, protowire::GetInfoRequestMessage);
from!(item: RpcResult<&sahyadri_rpc_core::GetInfoResponse>, protowire::GetInfoResponseMessage, {
    Self {
...
from!(item: &sahyadri_rpc_core::NotifyNewBlockTemplateRequest, protowire::NotifyNewBlockTemplateRequestMessage, {
    Self { command: item.command.into() }
});
from!(RpcResult<&sahyadri_rpc_core::NotifyNewBlockTemplateResponse>, protowire::NotifyNewBlockTemplateResponseMessage);

// ~~~

from!(&sahyadri_rpc_core::GetCurrentNetworkRequest, protowire::GetCurrentNetworkRequestMessage);
from!(item: RpcResult<&sahyadri_rpc_core::GetCurrentNetworkResponse>, protowire::GetCurrentNetworkResponseMessage, {
    Self { current_network: item.network.to_string(), error: None }
});

from!(&sahyadri_rpc_core::GetPeerAddressesRequest, protowire::GetPeerAddressesRequestMessage);
from!(item: RpcResult<&sahyadri_rpc_core::GetPeerAddressesResponse>, protowire::GetPeerAddressesResponseMessage, {
    Self {
...
from!(&sahyadri_rpc_core::GetSinkRequest, protowire::GetSinkRequestMessage);
from!(item: RpcResult<&sahyadri_rpc_core::GetSinkResponse>, protowire::GetSinkResponseMessage, {
    Self { sink: item.sink.to_string(), error: None }
});

from!(item: &sahyadri_rpc_core::GetMempoolEntryRequest, protowire::GetMempoolEntryRequestMessage, {
    Self {
...
from!(item: RpcResult<&sahyadri_rpc_core::GetMempoolEntryResponse>, protowire::GetMempoolEntryResponseMessage, {
    Self { entry: Some((&item.mempool_entry).into()), error: None }
});

from!(item: &sahyadri_rpc_core::GetMempoolEntriesRequest, protowire::GetMempoolEntriesRequestMessage, {
    Self { include_orphan_pool: item.include_orphan_pool, filter_transaction_pool: item.filter_transaction_pool }
});
from!(item: RpcResult<&sahyadri_rpc_core::GetMempoolEntriesResponse>, protowire::GetMempoolEntriesResponseMessage, {
    Self { entries: item.mempool_entries.iter().map(|x| x.into()).collect(), error: None }
});

from!(&sahyadri_rpc_core::GetConnectedPeerInfoRequest, protowire::GetConnectedPeerInfoRequestMessage);
from!(item: RpcResult<&sahyadri_rpc_core::GetConnectedPeerInfoResponse>, protowire::GetConnectedPeerInfoResponseMessage, {
    Self { infos: item.peer_info.iter().map(|x| x.into()).collect(), error: None }
});

from!(item: &sahyadri_rpc_core::AddPeerRequest, protowire::AddPeerRequestMessage, {
    Self { address: item.peer_address.to_string(), is_permanent: item.is_permanent }
});
from!(RpcResult<&sahyadri_rpc_core::AddPeerResponse>, protowire::AddPeerResponseMessage);

from!(item: &sahyadri_rpc_core::SubmitTransactionRequest, protowire::SubmitTransactionRequestMessage, {
    Self { transaction: Some((&item.transaction).into()), allow_orphan: item.allow_orphan }
});
from!(item: RpcResult<&sahyadri_rpc_core::SubmitTransactionResponse>, protowire::SubmitTransactionResponseMessage, {
    Self { transaction_id: item.transaction_id.to_string(), error: None }
});

from!(item: &sahyadri_rpc_core::SubmitTransactionReplacementRequest, protowire::SubmitTransactionReplacementRequestMessage, {
    Self { transaction: Some((&item.transaction).into()) }
});

from!(item: RpcResult<&sahyadri_rpc_core::SubmitTransactionReplacementResponse>, protowire::SubmitTransactionReplacementResponseMessage, {
...
from!(item: &sahyadri_rpc_core::GetSubnetworkRequest, protowire::GetSubnetworkRequestMessage, {
    Self { subnetwork_id: item.subnetwork_id.to_string() }
});
from!(item: RpcResult<&sahyadri_rpc_core::GetSubnetworkResponse>, protowire::GetSubnetworkResponseMessage, {
    Self { gas_limit: item.gas_limit, error: None }
});

from!(item: &sahyadri_rpc_core::GetVirtualChainFromBlockRequest, protowire::GetVirtualChainFromBlockRequestMessage, {
...
from!(item: RpcResult<&sahyadri_rpc_core::GetVirtualChainFromBlockResponse>, protowire::GetVirtualChainFromBlockResponseMessage, {
    Self {
...
from!(item: &sahyadri_rpc_core::GetBlocksRequest, protowire::GetBlocksRequestMessage, {
    Self {
...
from!(item: RpcResult<&sahyadri_rpc_core::GetBlocksResponse>, protowire::GetBlocksResponseMessage, {
    Self {
...
from!(&sahyadri_rpc_core::GetBlockCountRequest, protowire::GetBlockCountRequestMessage);
from!(item: RpcResult<&sahyadri_rpc_core::GetBlockCountResponse>, protowire::GetBlockCountResponseMessage, {
    Self { block_count: item.block_count, header_count: item.header_count, error: None }
});

from!(&sahyadri_rpc_core::GetSahyadriDagInfoRequest, protowire::GetSahyadriDagInfoRequestMessage);
from!(item: RpcResult<&sahyadri_rpc_core::GetSahyadriDagInfoResponse>, protowire::GetSahyadriDagInfoResponseMessage, {
    Self {
...
from!(item: &sahyadri_rpc_core::ResolveFinalityConflictRequest, protowire::ResolveFinalityConflictRequestMessage, {
    Self { finality_block_hash: item.finality_block_hash.to_string() }
});
from!(_item: RpcResult<&sahyadri_rpc_core::ResolveFinalityConflictResponse>, protowire::ResolveFinalityConflictResponseMessage, {
    Self { error: None }
});

from!(&sahyadri_rpc_core::ShutdownRequest, protowire::ShutdownRequestMessage);
from!(RpcResult<&sahyadri_rpc_core::ShutdownResponse>, protowire::ShutdownResponseMessage);

from!(item: &sahyadri_rpc_core::GetHeadersRequest, protowire::GetHeadersRequestMessage, {
    Self { start_hash: item.start_hash.to_string(), limit: item.limit, is_ascending: item.is_ascending }
});
from!(item: RpcResult<&sahyadri_rpc_core::GetHeadersResponse>, protowire::GetHeadersResponseMessage, {
...
from!(item: &sahyadri_rpc_core::GetBalanceByAddressRequest, protowire::GetBalanceByAddressRequestMessage, {
...
from!(&sahyadri_rpc_core::GetSinkBlueScoreRequest, protowire::GetSinkBlueScoreRequestMessage);
from!(item: RpcResult<&sahyadri_rpc_core::GetSinkBlueScoreResponse>, protowire::GetSinkBlueScoreResponseMessage, {
    Self { blue_score: item.blue_score, error: None }
});

from!(item: &sahyadri_rpc_core::BanRequest, protowire::BanRequestMessage, { Self { ip: item.ip.to_string() } });
from!(_item: RpcResult<&sahyadri_rpc_core::BanResponse>, protowire::BanResponseMessage, { Self { error: None } });

from!(item: &sahyadri_rpc_core::UnbanRequest, protowire::UnbanRequestMessage, { Self { ip: item.ip.to_string() } });
from!(_item: RpcResult<&sahyadri_rpc_core::UnbanResponse>, protowire::UnbanResponseMessage, { Self { error: None } });

from!(item: &sahyadri_rpc_core::EstimateNetworkHashesPerSecondRequest, protowire::EstimateNetworkHashesPerSecondRequestMessage, {
    Self { window_size: item.window_size, start_hash: item.start_hash.map_or(Default::default(), |x| x.to_string()) }
});
from!(
    item: RpcResult<&sahyadri_rpc_core::EstimateNetworkHashesPerSecondResponse>,
...
from!(item: &sahyadri_rpc_core::GetMempoolEntriesByAddressesRequest, protowire::GetMempoolEntriesByAddressesRequestMessage, {
    Self {
...
from!(
    item: RpcResult<&sahyadri_rpc_core::GetMempoolEntriesByAddressesResponse>,
    protowire::GetMempoolEntriesByAddressesResponseMessage,
    { Self { entries: item.entries.iter().map(|x| x.into()).collect(), error: None } }
);

from!(&sahyadri_rpc_core::GetCoinSupplyRequest, protowire::GetCoinSupplyRequestMessage);
from!(item: RpcResult<&sahyadri_rpc_core::GetCoinSupplyResponse>, protowire::GetCoinSupplyResponseMessage, {
    Self { max_kana: item.max_kana, circulating_kana: item.circulating_kana, error: None }
});

from!(item: &sahyadri_rpc_core::GetDaaScoreTimestampEstimateRequest, protowire::GetDaaScoreTimestampEstimateRequestMessage, {
    Self {
        daa_scores: item.daa_scores.clone()
    }
});
from!(item: RpcResult<&sahyadri_rpc_core::GetDaaScoreTimestampEstimateResponse>, protowire::GetDaaScoreTimestampEstimateResponseMessage, {
    Self { timestamps: item.timestamps.clone(), error: None }
});

// Fee estimate API

from!(&sahyadri_rpc_core::GetFeeEstimateRequest, protowire::GetFeeEstimateRequestMessage);
from!(item: RpcResult<&sahyadri_rpc_core::GetFeeEstimateResponse>, protowire::GetFeeEstimateResponseMessage, {
    Self { estimate: Some((&item.estimate).into()), error: None }
});
from!(item: &sahyadri_rpc_core::GetFeeEstimateExperimentalRequest, protowire::GetFeeEstimateExperimentalRequestMessage, {
    Self {
        verbose: item.verbose
    }
});
from!(item: RpcResult<&sahyadri_rpc_core::GetFeeEstimateExperimentalResponse>, protowire::GetFeeEstimateExperimentalResponseMessage, {
    Self {
...
from!(item: &sahyadri_rpc_core::GetCurrentBlockColorRequest, protowire::GetCurrentBlockColorRequestMessage, {
    Self {
        hash: item.hash.to_string()
    }
});
from!(item: RpcResult<&sahyadri_rpc_core::GetCurrentBlockColorResponse>, protowire::GetCurrentBlockColorResponseMessage, {
...
from!(&sahyadri_rpc_core::PingRequest, protowire::PingRequestMessage);
from!(RpcResult<&sahyadri_rpc_core::PingResponse>, protowire::PingResponseMessage);

from!(item: &sahyadri_rpc_core::GetMetricsRequest, protowire::GetMetricsRequestMessage, {
    Self {
...
from!(item: RpcResult<&sahyadri_rpc_core::GetMetricsResponse>, protowire::GetMetricsResponseMessage, {
    Self {
...
from!(item: &sahyadri_rpc_core::GetConnectionsRequest, protowire::GetConnectionsRequestMessage, {
    Self {
        include_profile_data : item.include_profile_data,
    }
});
from!(item: RpcResult<&sahyadri_rpc_core::GetConnectionsResponse>, protowire::GetConnectionsResponseMessage, {
    Self {
...
from!(&sahyadri_rpc_core::GetSystemInfoRequest, protowire::GetSystemInfoRequestMessage);
from!(item: RpcResult<&sahyadri_rpc_core::GetSystemInfoResponse>, protowire::GetSystemInfoResponseMessage, {
    Self {
...
from!(&sahyadri_rpc_core::GetServerInfoRequest, protowire::GetServerInfoRequestMessage);
from!(item: RpcResult<&sahyadri_rpc_core::GetServerInfoResponse>, protowire::GetServerInfoResponseMessage, {
    Self {
...
from!(&sahyadri_rpc_core::GetSyncStatusRequest, protowire::GetSyncStatusRequestMessage);
from!(item: RpcResult<&sahyadri_rpc_core::GetSyncStatusResponse>, protowire::GetSyncStatusResponseMessage, {
    Self {
        is_synced: item.is_synced,
        error: None,
    }
...
from!(item: &sahyadri_rpc_core::GetVirtualChainFromBlockV2Request, protowire::GetVirtualChainFromBlockV2RequestMessage, {
    Self {
...
from!(item: RpcResult<&sahyadri_rpc_core::GetVirtualChainFromBlockV2Response>, protowire::GetVirtualChainFromBlockV2ResponseMessage, {
    Self {
        removed_chain_block_hashes: item.removed_chain_block_hashes.iter().map(|x| x.to_string()).collect(),
        added_chain_block_hashes: item.added_chain_block_hashes.iter().map(|x| x.to_string()).collect(),
...
from!(RpcResult<&sahyadri_rpc_core::NotifyFinalityConflictResponse>, protowire::NotifyFinalityConflictResponseMessage);

from!(item: &sahyadri_rpc_core::NotifyVirtualDaaScoreChangedRequest, protowire::NotifyVirtualDaaScoreChangedRequestMessage, {
    Self { command: item.command.into() }
});
from!(RpcResult<&sahyadri_rpc_core::NotifyVirtualDaaScoreChangedResponse>, protowire::NotifyVirtualDaaScoreChangedResponseMessage);

from!(item: &sahyadri_rpc_core::NotifyVirtualChainChangedRequest, protowire::NotifyVirtualChainChangedRequestMessage, {
    Self { include_accepted_transaction_ids: item.include_accepted_transaction_ids, command: item.command.into() }
});
from!(RpcResult<&sahyadri_rpc_core::NotifyVirtualChainChangedResponse>, protowire::NotifyVirtualChainChangedResponseMessage);

from!(item: &sahyadri_rpc_core::NotifySinkBlueScoreChangedRequest, protowire::NotifySinkBlueScoreChangedRequestMessage, {
    Self { command: item.command.into() }
});
from!(RpcResult<&sahyadri_rpc_core::NotifySinkBlueScoreChangedResponse>, protowire::NotifySinkBlueScoreChangedResponseMessage);

// ----------------------------------------------------------------------------
// protowire to rpc_core
// ----------------------------------------------------------------------------

from!(item: RejectReason, sahyadri_rpc_core::SubmitBlockReport, {
    match item {
        RejectReason::None => sahyadri_rpc_core::SubmitBlockReport::Success,
        RejectReason::BlockInvalid => sahyadri_rpc_core::SubmitBlockReport::Reject(sahyadri_rpc_core::SubmitBlockRejectReason::BlockInvalid),
        RejectReason::IsInIbd => sahyadri_rpc_core::SubmitBlockReport::Reject(sahyadri_rpc_core::SubmitBlockRejectReason::IsInIBD),
    }
});

try_from!(item: &protowire::SubmitBlockRequestMessage, sahyadri_rpc_core::SubmitBlockRequest, {
    Self {
        block: item
            .block
            .as_ref()
...
impl TryFrom<&protowire::SubmitBlockResponseMessage> for sahyadri_rpc_core::SubmitBlockResponse {
    type Error = RpcError;
    // This conversion breaks the general conversion convention (see file header) since the message may
...
try_from!(item: &protowire::GetBlockTemplateRequestMessage, sahyadri_rpc_core::GetBlockTemplateRequest, {
    Self { pay_address: item.pay_address.clone().try_into()?, extra_data: RpcExtraData::from_iter(item.extra_data.bytes()) }
});
try_from!(item: &protowire::GetBlockTemplateResponseMessage, RpcResult<sahyadri_rpc_core::GetBlockTemplateResponse>, {
    Self {
        block: item
            .block
            .as_ref()
...
try_from!(item: &protowire::GetBlockRequestMessage, sahyadri_rpc_core::GetBlockRequest, {
    Self { hash: RpcHash::from_str(&item.hash)?, include_transactions: item.include_transactions }
});
try_from!(item: &protowire::GetBlockResponseMessage, RpcResult<sahyadri_rpc_core::GetBlockResponse>, {
    Self {
        block: item
            .block
            .as_ref()
...
try_from!(item: &protowire::NotifyBlockAddedRequestMessage, sahyadri_rpc_core::NotifyBlockAddedRequest, {
    Self { command: item.command.into() }
});
try_from!(&protowire::NotifyBlockAddedResponseMessage, RpcResult<sahyadri_rpc_core::NotifyBlockAddedResponse>);

try_from!(&protowire::GetInfoRequestMessage, sahyadri_rpc_core::GetInfoRequest);
try_from!(item: &protowire::GetInfoResponseMessage, RpcResult<sahyadri_rpc_core::GetInfoResponse>, {
    Self {
        p2p_id: item.p2p_id.clone(),
        mempool_size: item.mempool_size,
        server_version: item.server_version.clone(),
...
try_from!(item: &protowire::NotifyNewBlockTemplateRequestMessage, sahyadri_rpc_core::NotifyNewBlockTemplateRequest, {
    Self { command: item.command.into() }
});
try_from!(&protowire::NotifyNewBlockTemplateResponseMessage, RpcResult<sahyadri_rpc_core::NotifyNewBlockTemplateResponse>);

// ~~~

try_from!(&protowire::GetCurrentNetworkRequestMessage, sahyadri_rpc_core::GetCurrentNetworkRequest);
try_from!(item: &protowire::GetCurrentNetworkResponseMessage, RpcResult<sahyadri_rpc_core::GetCurrentNetworkResponse>, {
...
try_from!(&protowire::GetPeerAddressesRequestMessage, sahyadri_rpc_core::GetPeerAddressesRequest);
try_from!(item: &protowire::GetPeerAddressesResponseMessage, RpcResult<sahyadri_rpc_core::GetPeerAddressesResponse>, {
    Self {
...
try_from!(&protowire::GetSinkRequestMessage, sahyadri_rpc_core::GetSinkRequest);
try_from!(item: &protowire::GetSinkResponseMessage, RpcResult<sahyadri_rpc_core::GetSinkResponse>, {
    Self { sink: RpcHash::from_str(&item.sink)? }
});

try_from!(item: &protowire::GetMempoolEntryRequestMessage, sahyadri_rpc_core::GetMempoolEntryRequest, {
    Self {
        transaction_id: sahyadri_rpc_core::RpcTransactionId::from_str(&item.tx_id)?,
        include_orphan_pool: item.include_orphan_pool,
        filter_transaction_pool: item.filter_transaction_pool,
    }
});
try_from!(item: &protowire::GetMempoolEntryResponseMessage, RpcResult<sahyadri_rpc_core::GetMempoolEntryResponse>, {
    Self {
        mempool_entry: item
            .entry
            .as_ref()
...
try_from!(item: &protowire::GetMempoolEntriesRequestMessage, sahyadri_rpc_core::GetMempoolEntriesRequest, {
    Self { include_orphan_pool: item.include_orphan_pool, filter_transaction_pool: item.filter_transaction_pool }
});
try_from!(item: &protowire::GetMempoolEntriesResponseMessage, RpcResult<sahyadri_rpc_core::GetMempoolEntriesResponse>, {
    Self { mempool_entries: item.entries.iter().map(sahyadri_rpc_core::RpcMempoolEntry::try_from).collect::<Result<Vec<_>, _>>()? }
});

try_from!(&protowire::GetConnectedPeerInfoRequestMessage, sahyadri_rpc_core::GetConnectedPeerInfoRequest);
try_from!(item: &protowire::GetConnectedPeerInfoResponseMessage, RpcResult<sahyadri_rpc_core::GetConnectedPeerInfoResponse>, {
    Self { peer_info: item.infos.iter().map(sahyadri_rpc_core::RpcPeerInfo::try_from).collect::<Result<Vec<_>, _>>()? }
});

try_from!(item: &protowire::AddPeerRequestMessage, sahyadri_rpc_core::AddPeerRequest, {
    Self { peer_address: RpcContextualPeerAddress::from_str(&item.address)?, is_permanent: item.is_permanent }
});
try_from!(&protowire::AddPeerResponseMessage, RpcResult<sahyadri_rpc_core::AddPeerResponse>);

try_from!(item: &protowire::SubmitTransactionRequestMessage, sahyadri_rpc_core::SubmitTransactionRequest, {
    Self {
        transaction: item
            .transaction
            .as_ref()
...
try_from!(item: &protowire::SubmitTransactionResponseMessage, RpcResult<sahyadri_rpc_core::SubmitTransactionResponse>, {
    Self { transaction_id: RpcHash::from_str(&item.transaction_id)? }
});

try_from!(item: &protowire::SubmitTransactionReplacementRequestMessage, sahyadri_rpc_core::SubmitTransactionReplacementRequest, {
    Self {
        transaction: item
            .transaction
            .as_ref()
...
try_from!(item: &protowire::SubmitTransactionReplacementResponseMessage, RpcResult<sahyadri_rpc_core::SubmitTransactionReplacementResponse>, {
    Self {
...
try_from!(item: &protowire::GetSubnetworkRequestMessage, sahyadri_rpc_core::GetSubnetworkRequest, {
    Self { subnetwork_id: sahyadri_rpc_core::RpcSubnetworkId::from_str(&item.subnetwork_id)? }
});
try_from!(item: &protowire::GetSubnetworkResponseMessage, RpcResult<sahyadri_rpc_core::GetSubnetworkResponse>, {
    Self { gas_limit: item.gas_limit }
});

try_from!(item: &protowire::GetVirtualChainFromBlockRequestMessage, sahyadri_rpc_core::GetVirtualChainFromBlockRequest, {
...
try_from!(item: &protowire::GetVirtualChainFromBlockResponseMessage, RpcResult<sahyadri_rpc_core::GetVirtualChainFromBlockResponse>, {
    Self {
...
try_from!(item: &protowire::GetVirtualChainFromBlockV2RequestMessage, sahyadri_rpc_core::GetVirtualChainFromBlockV2Request, {
    Self {
...
try_from!(item: &protowire::GetVirtualChainFromBlockV2ResponseMessage, RpcResult<sahyadri_rpc_core::GetVirtualChainFromBlockV2Response>, {
    Self {
...
try_from!(item: &protowire::GetBlocksRequestMessage, sahyadri_rpc_core::GetBlocksRequest, {
    Self {
...
try_from!(item: &protowire::GetBlocksResponseMessage, RpcResult<sahyadri_rpc_core::GetBlocksResponse>, {
    Self {
...
try_from!(&protowire::GetBlockCountRequestMessage, sahyadri_rpc_core::GetBlockCountRequest);
try_from!(item: &protowire::GetBlockCountResponseMessage, RpcResult<sahyadri_rpc_core::GetBlockCountResponse>, {
    Self { header_count: item.header_count, block_count: item.block_count }
});

try_from!(&protowire::GetSahyadriDagInfoRequestMessage, sahyadri_rpc_core::GetSahyadriDagInfoRequest);
try_from!(item: &protowire::GetSahyadriDagInfoResponseMessage, RpcResult<sahyadri_rpc_core::GetSahyadriDagInfoResponse>, {
    Self {
        network: sahyadri_rpc_core::RpcNetworkId::from_prefixed(&item.network_name)?,
        block_count: item.block_count,
        header_count: item.header_count,
...
try_from!(item: &protowire::ResolveFinalityConflictRequestMessage, sahyadri_rpc_core::ResolveFinalityConflictRequest, {
    Self { finality_block_hash: RpcHash::from_str(&item.finality_block_hash)? }
});
try_from!(&protowire::ResolveFinalityConflictResponseMessage, RpcResult<sahyadri_rpc_core::ResolveFinalityConflictResponse>);

try_from!(&protowire::ShutdownRequestMessage, sahyadri_rpc_core::ShutdownRequest);
try_from!(&protowire::ShutdownResponseMessage, RpcResult<sahyadri_rpc_core::ShutdownResponse>);

try_from!(item: &protowire::GetHeadersRequestMessage, sahyadri_rpc_core::GetHeadersRequest, {
    Self { start_hash: RpcHash::from_str(&item.start_hash)?, limit: item.limit, is_ascending: item.is_ascending }
});
try_from!(item: &protowire::GetHeadersResponseMessage, RpcResult<sahyadri_rpc_core::GetHeadersResponse>, {
    // TODO
    Self { headers: vec![] }
});
...
try_from!(item: &protowire::GetBalancesByAddressesResponseMessage, RpcResult<sahyadri_rpc_core::GetBalancesByAddressesResponse>, {
    Self { entries: item.entries.iter().map(|x| x.try_into()).collect::<Result<Vec<_>, _>>()? }
});

try_from!(&protowire::GetSinkBlueScoreRequestMessage, sahyadri_rpc_core::GetSinkBlueScoreRequest);
try_from!(item: &protowire::GetSinkBlueScoreResponseMessage, RpcResult<sahyadri_rpc_core::GetSinkBlueScoreResponse>, {
    Self { blue_score: item.blue_score }
});

try_from!(item: &protowire::BanRequestMessage, sahyadri_rpc_core::BanRequest, { Self { ip: RpcIpAddress::from_str(&item.ip)? } });
try_from!(&protowire::BanResponseMessage, RpcResult<sahyadri_rpc_core::BanResponse>);

try_from!(item: &protowire::UnbanRequestMessage, sahyadri_rpc_core::UnbanRequest, { Self { ip: RpcIpAddress::from_str(&item.ip)? } });
try_from!(&protowire::UnbanResponseMessage, RpcResult<sahyadri_rpc_core::UnbanResponse>);

try_from!(item: &protowire::EstimateNetworkHashesPerSecondRequestMessage, sahyadri_rpc_core::EstimateNetworkHashesPerSecondRequest, {
    Self {
...
try_from!(
    ...
    RpcResult<sahyadri_rpc_core::EstimateNetworkHashesPerSecondResponse>,
    { Self { network_hashes_per_second: item.network_hashes_per_second } }
);

try_from!(item: &protowire::GetMempoolEntriesByAddressesRequestMessage, sahyadri_rpc_core::GetMempoolEntriesByAddressesRequest, {
    Self {
...
try_from!(
    ...
    RpcResult<sahyadri_rpc_core::GetMempoolEntriesByAddressesResponse>,
    { Self { entries: item.entries.iter().map(|x| x.try_into()).collect::<Result<Vec<_>, _>>()? } }
);

try_from!(&protowire::GetCoinSupplyRequestMessage, sahyadri_rpc_core::GetCoinSupplyRequest);
try_from!(item: &protowire::GetCoinSupplyResponseMessage, RpcResult<sahyadri_rpc_core::GetCoinSupplyResponse>, {
    Self { max_kana: item.max_kana, circulating_kana: item.circulating_kana }
});

try_from!(item: &protowire::GetDaaScoreTimestampEstimateRequestMessage, sahyadri_rpc_core::GetDaaScoreTimestampEstimateRequest , {
    Self {
        daa_scores: item.daa_scores.clone()
    }
});
try_from!(item: &protowire::GetDaaScoreTimestampEstimateResponseMessage, RpcResult<sahyadri_rpc_core::GetDaaScoreTimestampEstimateResponse>, {
    Self { timestamps: item.timestamps.clone() }
});

try_from!(&protowire::GetFeeEstimateRequestMessage, sahyadri_rpc_core::GetFeeEstimateRequest);
try_from!(item: &protowire::GetFeeEstimateResponseMessage, RpcResult<sahyadri_rpc_core::GetFeeEstimateResponse>, {
    Self {
...
try_from!(item: &protowire::GetFeeEstimateExperimentalRequestMessage, sahyadri_rpc_core::GetFeeEstimateExperimentalRequest, {
    Self {
        verbose: item.verbose
    }
});
try_from!(item: &protowire::GetFeeEstimateExperimentalResponseMessage, RpcResult<sahyadri_rpc_core::GetFeeEstimateExperimentalResponse>, {
    Self {
        estimate: item.estimate
            .as_ref()
...
try_from!(item: &protowire::GetCurrentBlockColorRequestMessage, sahyadri_rpc_core::GetCurrentBlockColorRequest, {
    Self {
        hash: RpcHash::from_str(&item.hash)?
    }
});
try_from!(item: &protowire::GetCurrentBlockColorResponseMessage, RpcResult<sahyadri_rpc_core::GetCurrentBlockColorResponse>, {
    Self {
        blue: item.blue
    }
});
...
try_from!(&protowire::PingRequestMessage, sahyadri_rpc_core::PingRequest);
try_from!(&protowire::PingResponseMessage, RpcResult<sahyadri_rpc_core::PingResponse>);

try_from!(item: &protowire::GetMetricsRequestMessage, sahyadri_rpc_core::GetMetricsRequest, {
    Self {
        process_metrics: item.process_metrics,
        connection_metrics: item.connection_metrics,
        bandwidth_metrics:item.bandwidth_metrics,
...
try_from!(item: &protowire::GetMetricsResponseMessage, RpcResult<sahyadri_rpc_core::GetMetricsResponse>, {
    Self {
        server_time: item.server_time,
...
try_from!(item: &protowire::GetConnectionsRequestMessage, sahyadri_rpc_core::GetConnectionsRequest, {
    Self { include_profile_data : item.include_profile_data }
});
try_from!(item: &protowire::GetConnectionsResponseMessage, RpcResult<sahyadri_rpc_core::GetConnectionsResponse>, {
    Self {
        clients: item.clients,
...
try_from!(&protowire::GetSystemInfoRequestMessage, sahyadri_rpc_core::GetSystemInfoRequest);
try_from!(item: &protowire::GetSystemInfoResponseMessage, RpcResult<sahyadri_rpc_core::GetSystemInfoResponse>, {
    Self {
        version: item.version.clone(),
...
try_from!(&protowire::GetServerInfoRequestMessage, sahyadri_rpc_core::GetServerInfoRequest);
try_from!(item: &protowire::GetServerInfoResponseMessage, RpcResult<sahyadri_rpc_core::GetServerInfoResponse>, {
    Self {
...
try_from!(&protowire::GetSyncStatusRequestMessage, sahyadri_rpc_core::GetSyncStatusRequest);
try_from!(item: &protowire::GetSyncStatusResponseMessage, RpcResult<sahyadri_rpc_core::GetSyncStatusResponse>, {
    Self {
        is_synced: item.is_synced,
    }
});
...
try_from!(&protowire::NotifyFinalityConflictResponseMessage, RpcResult<sahyadri_rpc_core::NotifyFinalityConflictResponse>);

try_from!(item: &protowire::NotifyVirtualDaaScoreChangedRequestMessage, sahyadri_rpc_core::NotifyVirtualDaaScoreChangedRequest, {
    Self { command: item.command.into() }
});
try_from!(&protowire::NotifyVirtualDaaScoreChangedResponseMessage, RpcResult<sahyadri_rpc_core::NotifyVirtualDaaScoreChangedResponse>);

try_from!(item: &protowire::NotifyVirtualChainChangedRequestMessage, sahyadri_rpc_core::NotifyVirtualChainChangedRequest, {
    Self { include_accepted_transaction_ids: item.include_accepted_transaction_ids, command: item.command.into() }
});
try_from!(&protowire::NotifyVirtualChainChangedResponseMessage, RpcResult<sahyadri_rpc_core::NotifyVirtualChainChangedResponse>);

try_from!(item: &protowire::NotifySinkBlueScoreChangedRequestMessage, sahyadri_rpc_core::NotifySinkBlueScoreChangedRequest, {
    Self { command: item.command.into() }
});
try_from!(&protowire::NotifySinkBlueScoreChangedResponseMessage, RpcResult<sahyadri_rpc_core::NotifySinkBlueScoreChangedResponse>);
...
#[cfg(test)]
mod tests {
    use sahyadri_rpc_core::{RpcError, RpcResult, SubmitBlockRejectReason, SubmitBlockReport, SubmitBlockResponse};
    ...
    fn test_submit_block_response() {
        struct Test {
            rpc_core: RpcResult<sahyadri_rpc_core::SubmitBlockResponse>,
