use crate::protowire::{sahyadrid_request::Payload as RequestPayload, sahyadrid_response::Payload as ResponsePayload, *};
...
pub enum SahyadridPayloadOps {
    ...
    // The conversion from a notification ResponsePayload into SahyadridPayloadOps fails.
}
}
