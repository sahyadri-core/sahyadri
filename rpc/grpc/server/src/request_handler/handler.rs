use super::{
    ...
    interface::{DynSahyadridMethod, Interface},
};
use crate::{
...
impl RequestHandler {
    ...
    pub async fn handle_request(&self, request: SahyadridRequest) -> GrpcServerResult<SahyadridResponse> {
        let id = request.id;
