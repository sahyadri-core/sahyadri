...
use sahyadri_notify::scope::{NewBlockTemplateScope, Scope};
...
async fn test_client_server_sanity_check() {
    sahyadri_core::log::try_init_logger("info, sahyadri_grpc_core=trace, sahyadri_grpc_server=trace, sahyadri_grpc_client=trace");
