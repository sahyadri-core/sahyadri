...
use sahyadri_consensus_core::tx::{Transaction, TransactionInput, TransactionOutpoint, TransactionOutput};
...
impl Generator {
    ...
    /// The total amount of fees in KANA consumed during the transaction generation process.
    #[inline(always)]
