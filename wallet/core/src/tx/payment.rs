...
use crate::imports::*;
use sahyadri_consensus_client::{TransactionOutput, TransactionOutputInner};
...
export interface IPaymentOutput {
     ...
     * you are transacting on (e.g. `sahyadri:` for mainnet, `sahyadritest:` for testnet, etc).
     */
    address: Address | string;
    /**
     * Output amount in KANA.
     */
    amount: bigint;
}
"#;
