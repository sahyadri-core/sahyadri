...
/// the mempool and relayed. It is specified in kana per 1kg (or 1000 grams) of transaction mass.
...
pub fn calc_minimum_required_transaction_relay_fee(mass: u64) -> u64 {
    ...
    // kana/kg so multiply by mass (which is in grams) and divide by 1000 to get
    // minimum kanas.
    ...
    minimum_fee = minimum_fee.min(MAX_KANA);
...
//     // if let Some(dust_threshold_kana) = network_params.dust_threshold_kana {
//     //     return value < dust_threshold_kana;
//     // } else {
//     match value.checked_mul(1000) {
//         Some(value_1000) => value_1000 / STANDARD_OUTPUT_SIZE_PLUS_INPUT_SIZE_3X < MINIMUM_RELAY_TRANSACTION_FEE,
//         None => (value as u128 * 1000 / STANDARD_OUTPUT_SIZE_PLUS_INPUT_SIZE_3X as u128) < MINIMUM_RELAY_TRANSACTION_FEE as u128,
