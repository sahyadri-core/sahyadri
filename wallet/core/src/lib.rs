...
//! <https://sahyadri.aspectron.org/docs/>
//!
...
//! the `sahyadri` module includes `websocket` module dependency simulating
...
extern crate alloc;
extern crate self as sahyadri_wallet_core;
...
pub fn version_with_git_hash() -> String {
    sahyadri_utils::git::with_short_hash(env!("CARGO_PKG_VERSION")).to_string()
}
