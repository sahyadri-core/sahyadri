...
use sahyadri_notify::events::EVENT_TYPE_ARRAY;
use sahyadri_notify::listener::{ListenerId, ListenerLifespan};
...
use sahyadri_rpc_core::api::ctl::RpcCtl;
...
impl RpcCoreMock {
    ...
    #[allow(dead_code)]
    pub fn notify_new_block_template(&self) -> sahyadri_notify::error::Result<()> {
...
impl RpcApi for RpcCoreMock {
    ...
    async fn get_sahyadri_dag_info_call(
        &self,
        _connection: Option<&DynRpcConnection>,
        _request: GetSahyadriDagInfoRequest,
