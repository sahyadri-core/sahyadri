...
impl Prefix {
    ...
    /// `kprv` prefix
    pub const KPRV: Self = Self::from_parts_unchecked("cprv", 0x038f2ef4);

    /// `kpub` prefix
    pub const KPUB: Self = Self::from_parts_unchecked("cpub", 0x038f332e);

    /// `ktrv` prefix
    pub const KTRV: Self = Self::from_parts_unchecked("ctrv", 0x03909e07);

    /// `ktub` prefix
    pub const KTUB: Self = Self::from_parts_unchecked("ctub", 0x0390a241);
