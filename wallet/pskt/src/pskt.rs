...
use sahyadri_consensus_core::mass::{MassCalculator, NonContextualMasses};
...
pub struct KeySource {
    #[serde(with = "sahyadri_utils::serde_bytes_fixed")]
...
///
/// A Partially Signed Sahyadri Transaction (PSKT) is a standardized format
/// that allows multiple participants to collaborate in creating and signing
/// a Sahyadri transaction. PSKT enables the exchange of incomplete transaction
