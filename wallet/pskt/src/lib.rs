//!
//! PSKT is a crate for working with Partially Signed Sahyadri Transactions (PSKTs).
...
//! multiple `PSKT` instances allowing for exchange of Sahyadri sweep transactions.
//!
