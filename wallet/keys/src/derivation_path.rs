...
pub struct DerivationPath {
    inner: sahyadri_bip32::DerivationPath,
}
...
impl DerivationPath {
    ...
    pub fn new(path: &str) -> Result<DerivationPath> {
        let inner = sahyadri_bip32::DerivationPath::from_str(path)?;
        Ok(Self { inner })
    }
...
impl<'a> From<&'a DerivationPath> for &'a sahyadri_bip32::DerivationPath {
