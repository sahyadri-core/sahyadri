use crate::imports::*;
use sahyadri_metrics_core::{Metrics as MetricsProcessor, MetricsSinkFn};
...
impl Metrics {
    ...
    pub async fn display_help(self: &Arc<Self>, ctx: Arc<SahyadriCli>, _argv: Vec<String>) -> Result<()> {
